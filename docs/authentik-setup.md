...
Configure an OAuth2/OpenID Provider in Authentik for the CFD Remote Assist portal.

## 1. Create an Application

1. In Authentik Admin, go to **Applications → Applications → Create**.
2. Name: `CFD Remote Assist`
3. Slug: `cfd-remote-assist`
...
`https://<authentik-host>/application/o/cfd-remote-assist/`
...
- `VITE_OIDC_CLIENT_ID` = `cfd-remote-assist`
